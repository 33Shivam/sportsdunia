...
import { columns } from "../../components/ui/tables/columns";
...
const DDashboard = () => {
  ...
  const totalPayout = totalNumber * payoutRate;
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setTotalNumber(result.totalResults);
  ...
  return (
    <div className="flex flex-1 flex-row">
      <div className="p-2 md:p-5 rounded-tl-2xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 flex justify-between flex-row gap-6 flex-1 w-full h-full">
          ...
          <Card className="w-full h-fit">
            <CardHeader className="flex flex-col items-stretch space-y-0 border-b p-0 sm:flex-row">
              <div className="flex flex-1 flex-col justify-center gap-1 px-6 py-5 sm:py-6">
                ...
                <CardDescription>
                  Showing total articles for the last 3 months
                </CardDescription>
              </div>
              <div className="flex">
                <button className="relative z-30 flex flex-1 flex-col justify-center gap-1 border-t px-6 py-4 text-left bg-muted/50 sm:border-t-0 sm:px-8 sm:py-6">
            ...
            <CardContent className="px-2 sm:p-6">
              <BarChartComponent activeChart={activeChart} />
            </CardContent>
          </Card>
          <div className="flex-row w-full flex gap-4 flex">
            <Card>
              <CardHeader>
